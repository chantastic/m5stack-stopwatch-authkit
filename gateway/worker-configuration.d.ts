/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 76d5749324e9883ffdf83effebe1098d)
// Runtime types generated with workerd@1.20260911.1 2026-09-11 nodejs_compat
interface __BaseEnv_Env {
	DEVICES_CLIENT_ID: "client_01M24S76WQHXQ6QJJ7S83CMR3F";
	REPLIES: DurableObjectNamespace<import("./src/index").ReplyLedger>;
	DEVICES_IDENTITY: Service /* entrypoint DevicesIdentity from chan-identity-web */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ReplyLedger";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEVICES_CLIENT_ID">> {}
}
